...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
	...
	ADD_CUSTOM_TARGET(${_targetname}
		...
		COMMAND ${LCOV_PATH} --remove ${_outputname}.info '${PROJECT_SOURCE_DIR}/build/*' '${PROJECT_SOURCE_DIR}/tests/*' '/usr/*' 'include/gtest/*' 'src/*' --output-file ${_outputname}.info.cleaned
